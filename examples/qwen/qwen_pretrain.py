...
from hyperpod_nemo_adapter.collections.model.nlp import SageMakerQwenModel
...
def train(cfg: DictConfig) -> None:
    ...
    model_module = SageMakerQwenModel(cfg.model, trainer, use_smp_model=cfg.use_smp_model)
    trainer.fit(model_module, datamodule=data_module)


@hydra.main(config_path="conf", config_name="qwen_config", version_base="1.2")
@validate_config()
