#!/usr/bin/env python3
# NeMo 2.0 Qwen2.5-Coder-7B function-calling SFT using NeMo-Run (direct execution).
...
def parse_args():
    parser = argparse.ArgumentParser(description="NeMo 2.0 Qwen2.5-Coder-7B function-calling SFT")
...
def main() -> None:
    ...
    import_output = Path(args.import_output) if args.import_output else output_dir / "qwen25_7b_instruct.nemo"
    ...
    finetune = llm.qwen25_7b.finetune_recipe(
        name="qwen25_7b_fc_sft",
        num_nodes=nodes,
